...
def main():
    ...
    if args.path.is_dir():
        ...
        for file in time_ordered:
            try:
                ...
                plot_main(loaded_data, file.name if args.save else "")
                return
    ...
    try:
        ...
        plot_main(loaded_data, args.path.name if args.save else "")
        return
    except (json.JSONDecodeError, KeyError):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--save",
        action="store_true",
        help="Save as image, image name will be same as json file it opened.",
    )
